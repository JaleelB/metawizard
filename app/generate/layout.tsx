...
export default async function GeneratePageLayout({
  ...
  return (
    <div>
      <SiteHeader />
      <div className="container h-[calc(100vh - 56px)] flex-1 items-start md:grid md:grid-cols-[220px_minmax(0,1fr)] md:gap-6 lg:grid-cols-[240px_minmax(0,1fr)] lg:gap-10">
